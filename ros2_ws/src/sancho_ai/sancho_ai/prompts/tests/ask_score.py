...
def nombre_amigable(nombre):
    ...
    }.get(nombre, nombre)  # fallback si no se encuentra

def procesar_tarea(path_json):
    ...
    # Recorremos para calcular el tiempo máximo
    ...
    # Recorremos para calcular métricas
...
print("EXTRACCIÓN DE NOMBRE")
procesar_tarea("results_name.json")

print("\n\nCONFIRMACIÓN DE NOMBRE")
procesar_tarea("results_confirm.json")
