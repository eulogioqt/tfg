...
# HACER EL LLAMA EL DEEPSEEK Y TO LOS QUE SEAN GRATIS, EL GEMINI....
# HACER UNA FORMA DE DEFINIR LOS COMANDOS MAS CENTRALIZADA, EN UN SOLO ARCHIVO TODO, LOS TEMPLATES LA DESCRIPCION LOS ARGUMENTOS
# Y QUE HAYA UN CODIGO PARA GET NOSEQUE GET NOSECUANTOS LO QUE HAGA FALTA, PERO QUE ESTE TODO DEFINIDO EN UN SITIO
# Y DESPUES DEFINIR PARA CADA TIPO ALOMEON LAS COSAS, QUIZA UNA FUNCION QUE HACE LA CLASIFICACION SI O SI EN UN COMMANDS.TAL
# Y LUEGO YA SIEMPRE PASA AL MISMO METODO QUE CLASIFICA Y LLAMA A LAS FUNCIONES CON UN DICCIONARIO COMANDO FUNCION... CEPA DIO SABEEE
# PERO HACERLO BACAN SHAT Y ASI SE PUEDE DEFINIR FACILMENTE COMADNOS NUEVOS, LUEGO AHCER TESTS Y PROBAR CON TODOS LOS PROVIDERS

#cada provider ponerle las caracteristicas o algo, por ejemplo llama es bomba porque es local